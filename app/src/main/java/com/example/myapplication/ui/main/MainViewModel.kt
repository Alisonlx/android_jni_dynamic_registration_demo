...
import com.example.myapplication.util.cipher.ImageSteganography
import com.example.myapplication.util.system.lang.FileUtils
...
class MainViewModel @Inject constructor(
    ...
    val versionSignature : String
        get() = "App version : ${BuildConfig.VERSION_CODE} \nJNI version : ${Constants.Companion.coreJniVersion}, \nOpenCV version : ${Constants.Companion.openCVVersion}"
